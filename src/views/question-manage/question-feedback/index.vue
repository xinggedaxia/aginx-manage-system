<template>
  <div class="layout-content qustion-feedback">
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column label="反馈对象" prop="question" />
...
// import { fetchList, createAccount, updateAccount } from '@/api/qustion-feedback.js' fixme:替换为你的接口地址
import Pagination from '@/components/Pagination' // 分页

export default {
  name: 'QustionFeedback',
...
.qustion-feedback ::v-deep.qustion-feedback-dialog {
  max-width: 600px;
